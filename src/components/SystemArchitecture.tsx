const layers = [
  ...
  },
  {
    ...
    border: "border-brand-secondary/30 hover:border-brand-secondary/60",
  ...
  },
  {
    ...
    gradient: "from-brand-primary to-[#c026d3]",
    border: "border-brand-primary/30 hover:border-brand-primary/60",
    glow: "bg-[#c026d3]/10",
  },
];
...
export default function SystemArchitecture() {
  return (
    <section id="system-architecture" className="py-28 relative overflow-hidden bg-brand-bg">
      <div className="absolute inset-0 pointer-events-none opacity-20">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-brand-primary/30 rounded-full blur-[160px]" />
      </div>

      <div className="max-w-7xl mx-auto px-6">
        {/* Header */}
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-brand-secondary/20 bg-brand-secondary/10 text-brand-secondary text-[10px] font-black uppercase tracking-[0.3em] mb-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-0 items-stretch mb-20">
          {layers.map((layer, i) => (
            <div key={i} className="relative flex lg:flex-col">
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-[9px] uppercase tracking-[0.3em] font-black text-brand-secondary/70 mb-1.5">
                    {layer.subtitle}
                  </p>
                  <h3 className="text-white font-bold text-base mb-2 group-hover:text-brand-primary transition-colors leading-snug">
                    {layer.title}
                  </h3>
              ...
              {i < layers.length - 1 && (
                <div className="hidden lg:flex items-center justify-center absolute -right-1 top-1/2 -translate-y-1/2 z-20">
                  <div className="w-2 h-2 rotate-45 border-r border-t border-brand-primary/40" />
                </div>
              )}
            </div>
          ))}
        ...
        <div className="relative rounded-3xl overflow-hidden border border-brand-primary/20">
          ...
          <div className="absolute inset-0 animate-pulse-soft">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-brand-primary/15 rounded-full blur-[80px]" />
          </div>
          {/* Top gradient border */}
          ...
          <div className="relative z-10 text-center px-8 py-16 md:py-20">
            ...
            <h3 className="text-3xl md:text-5xl font-display font-extrabold mb-6 tracking-tight bg-gradient-to-r from-brand-primary via-brand-accent to-brand-secondary bg-clip-text text-transparent">
              Your Growth?
            </h3>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
              <a
                href="#book-call"
                className="group px-10 py-4 rounded-2xl bg-gradient-to-r from-brand-primary to-brand-secondary text-white font-black text-sm uppercase tracking-widest transition-all duration-300 hover:scale-105 hover:shadow-[0_0_40px_rgba(139,92,246,0.4)] active:scale-95 inline-flex items-center gap-3"
              >
