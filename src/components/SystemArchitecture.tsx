const layers = [
  {
    ...
    description: "Proprietary AI Persona Engines that flood the scroll with algorithm-native content, 3x a day — volume beats perfection, and visibility compounds without human intervention.",
    icon: (
  ...
  },
  {
    ...
    description: "CRM installation and inbound voice agents that instantly identify and categorise high-value intent — every lead captured, logged, and routed the moment it arrives.",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "90% of sales never close on first contact. Outbound voice agents and autonomous follow-up sequences build authority and stay in the conversation until the close happens.",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "A second brain for your business — remembering every lead, surfacing better offers, and orchestrating scheduling to payment without you lifting a finger.",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
