              ...
              {[
                {
                  ...
                  icon: (
                    <svg viewBox="0 0 24 24" className="w-4 h-4" aria-hidden="true">
                      <path
                        fill="currentColor"
                        d="M12 .5C5.648.5.5 5.648.5 12.01c0 5.104 3.313 9.435 7.912 10.962.579.106.79-.252.79-.559 0-.276-.01-1.01-.016-1.985-3.218.7-3.898-1.552-3.898-1.552-.528-1.34-1.29-1.698-1.29-1.698-1.055-.721.08-.707.08-.707 1.166.082 1.78 1.197 1.78 1.197 1.037 1.777 2.722 1.264 3.386.967.105-.751.406-1.264.739-1.554-2.569-.293-5.272-1.284-5.272-5.713 0-1.263.452-2.296 1.194-3.106-.12-.293-.518-1.473.112-3.07 0 0 .974-.312 3.192 1.187a11.07 11.07 0 0 1 2.91-.392c.986.005 1.98.133 2.91.392 2.217-1.499 3.189-1.187 3.189-1.187.632 1.597.235 2.777.116 3.07.744.81 1.192 1.843 1.192 3.106 0 4.442-2.708 5.417-5.287 5.705.418.36.79 1.078.79 2.174 0 1.57-.014 2.835-.014 3.222 0 .31.208.672.796.558C20.2 21.44 23.5 17.11 23.5 12.01 23.5 5.648 18.352.5 12 .5Z"
                      />
                    </svg>
                  ),
                },
